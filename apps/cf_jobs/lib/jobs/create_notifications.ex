defmodule CF.Jobs.CreateNotifications do
  ...
  or achievement_unlocked, they're not dispatched from here.
  ...
  defp start_analysis(actions) do
    Logger.info("[Jobs.NotificationsCreator] Update")
  ...
  defp build_notifications_for_action(action) do
    ...
    |> Enum.map(&insert_notifications/1)
  end

  @spec insert_notifications([%{}]) :: integer()
